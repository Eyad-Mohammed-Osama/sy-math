...
```
<p><code>getRemainder()</code> Returns A Positive Integer That Indicates The Remainder Of The Division.</p>
...
```
<p><code>randomPercentage()</code> Returns A Positive Integer That Indicates A Random Number Between 0 And 100 (Including 0 And 100).</p> 
